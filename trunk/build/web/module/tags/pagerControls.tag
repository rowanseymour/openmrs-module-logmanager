...
<input type="button"
	...
	title="<spring:message code="logmanager.pager.first" />"
/>
...
<input type="button"
	...
	title="<spring:message code="logmanager.pager.previous" />"
/>
...
<input type="button"
	...
	onclick="pager_set_offset(${pagingInfo.pageOffset + pagingInfo.pageSize})"
	title="<spring:message code="logmanager.pager.next" />"
/>
...
<input type="button"
	...
	title="<spring:message code="logmanager.pager.last" />"
/>