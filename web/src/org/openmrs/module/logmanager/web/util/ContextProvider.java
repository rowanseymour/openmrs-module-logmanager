...
import org.openmrs.module.logmanager.web.filter.RequestProviderFilter;
...
public class ContextProvider implements ApplicationContextAware, ServletContextAware {
	...
	/**
	 * Gets the servlet request associated with the current thread
	 * @return the http servlet request
	 */
	public static HttpServletRequest getServletRequest() {
		return RequestProviderFilter.getRequest();
	}
